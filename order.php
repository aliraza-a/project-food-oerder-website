  ...
  <div class="container">
    ...
    <form action="" method="POST" class="order">
      ...
      <fieldset>
        ...
        <input type="tel" name="contact" placeholder="012xxxxxx" class="input-responsive" required />
    ...
    if (isset($_POST['submit'])) {
      ...
      $sql2 = "INSERT INTO tbl_order SET food = '$food', price = '$price', qty = $qty, order_date = '$order_date', status = '$status', customer_name = '$customer_name', customer_contact = '$customer_contact', customer_email = '$customer_email', customer_address = '$customer_address'";
      $res2 = mysqli_query($conn, $sql2);
      if ($res2 == TRUE) {
        $_SESSION['order'] = "Order Successful!";
        header('location:' . SITEURL);
      } else {
        $_SESSION['order'] = "There was an error!";
        header('location:' . SITEURL);
      }
    }
    ?>
